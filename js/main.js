...
// 21  78
// function validate(){
//     if(regex.test(productName.value)==true && regexPrice.test(productPrice.value)==true ){
//         return true
//     }
//     else if(regex.test(productName.value)==false){
//         return 'name must start with capital letter min 3 max 5'
//     }
//     else if(regexPrice.test(productPrice.value)==false){
//         return 'min 21 max 78'
//     }
